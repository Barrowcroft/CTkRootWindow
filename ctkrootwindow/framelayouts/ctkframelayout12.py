...
class CTkFrameLayout12(CTkFrameLayout):
    """CTkFrameLayout12
    ...
    def __init__(
        ...
        **kwargs: Any,
        ...
        self._left.grid(row=0, column=0, padx=(0, gutter), pady=0, sticky="nsew")  # type: ignore - call to CustomTknter

        self._main = CTkFormattedFrame(self)
        self._main.grid(row=0, column=1, padx=(0, gutter), pady=0, sticky="nsew")  # type: ignore - call to CustomTknter

        self._right = CTkFormattedFrame(self, width=200)
        self._right.grid(row=0, column=2, padx=0, pady=0, sticky="nsew")  # type: ignore - call to CustomTknter

        #  Set the frame layout's descriptors

        self._str = "CTkFrameLayout12"
        self._repr = (
            "CTkFrameLayout12 (master={master}, *args={*args}, **kwargs={**kwargs})"
        )
