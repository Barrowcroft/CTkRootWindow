...
class CTkFrameLayout18(CTkFrameLayout):
    """CTkFrameLayout18
    ...
    def __init__(
        ...
        **kwargs: Any,
        ...
        self._main.grid(row=1, column=1, padx=0, pady=(0, gutter), sticky="nsew")  # type: ignore - call to CustomTknter

        self._bottom = CTkFormattedFrame(self, height=50)
        self._bottom.grid(row=2, column=1, padx=0, pady=0, sticky="nsew")  # type: ignore - call to CustomTknter

        #  Set the frame layout's descriptors

        self._str = "CTkFrameLayout18"
        self._repr = (
            "CTkFrameLayout18 (master={master}, *args={*args}, **kwargs={**kwargs})"
        )
