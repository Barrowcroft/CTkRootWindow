...
class CTkFrameLayout1(CTkFrameLayout):
    """CTkFrameLayout1
    ...
    def __init__(
        ...
        **kwargs: Any,
        ...
        self._main.grid(row=1, column=0, padx=0, pady=0, sticky="nsew")  # type: ignore - call to CustomTknter

        #  Set the frame layout's descriptors

        self._str = "CTkFrameLayout1"
        self._repr = (
            "CTkFrameLayout1 (master={master}, *args={*args}, **kwargs={**kwargs})"
        )
