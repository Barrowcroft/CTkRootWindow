...
class CTkFrameLayout20(CTkFrameLayout):
    """CTkFrameLayout20
    ...
    def __init__(
        ...
        **kwargs: Any,
        ...
        self._bottom.grid(row=1, column=0, padx=(0, gutter), pady=0, sticky="nsew")  # type: ignore - call to CustomTknter

        self._right = CTkFormattedFrame(self, width=200)
        self._right.grid(row=0, column=1, rowspan=2, padx=0, pady=0, sticky="nsew")  # type: ignore - call to CustomTknter

        #  Set the frame layout's descriptors

        self._str = "CTkFrameLayout20"
        self._repr = (
            "CTkFrameLayout20 (master={master}, *args={*args}, **kwargs={**kwargs})"
        )
