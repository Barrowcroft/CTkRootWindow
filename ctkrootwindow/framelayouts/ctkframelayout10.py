...
class CTkFrameLayout10(CTkFrameLayout):
    """CTkFrameLayout10
    ...
    def __init__(
        ...
        **kwargs: Any,
        ...
        self._right.grid(row=0, column=1, padx=0, pady=(0, gutter), sticky="nsew")  # type: ignore - call to CustomTknter
        ...
        self._str = "CTkFrameLayout10"
        self._repr = (
            "CTkFrameLayout10 (master={master}, *args={*args}, **kwargs={**kwargs})"
        )
