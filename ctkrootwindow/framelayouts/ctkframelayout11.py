...
class CTkFrameLayout11(CTkFrameLayout):
    """CTkFrameLayout11
    ...
    def __init__(
        ...
        **kwargs: Any,
        ...
        self._right.grid(row=1, column=1, padx=0, pady=(0, gutter), sticky="nsew")  # type: ignore - call to CustomTknter

        self._bottom = CTkFormattedFrame(self, height=50)
        self._bottom.grid(row=2, column=0, columnspan=2, padx=0, pady=0, sticky="nsew")  # type: ignore - call to CustomTknter

        #  Set the frame layout's descriptors

        self._str = "CTkFrameLayout11"
        self._repr = (
            "CTkFrameLayout11 (master={master}, *args={*args}, **kwargs={**kwargs})"
        )
