...
class CTkFrameLayout6(CTkFrameLayout):
    """CTkFrameLayout06
    ...
    def __init__(
        ...
        **kwargs: Any,
        ...
        #  Other frames will still be Non
        ...
        self._main.grid(row=0, column=1, padx=0, pady=(0, gutter), sticky="nsew")  # type: ignore - call to CustomTknter

        self._bottom = CTkFormattedFrame(self, height=50)
        self._bottom.grid(row=1, column=0, columnspan=2, padx=0, pady=0, sticky="nsew")  # type: ignore - call to CustomTknter

        #  Set the frame layout's descriptors

        self._str = "CTkFrameLayout6"
        self._repr = (
            "CTkFrameLayout6 (master={master}, *args={*args}, **kwargs={**kwargs})"
        )
