...
class CTkFrameLayout17(CTkFrameLayout):
    """CTkFrameLayout17
    ...
    def __init__(
        ...
        **kwargs: Any,
        ...
        self._bottom.grid(row=1, column=1, padx=0, pady=0, sticky="nsew")  # type: ignore - call to CustomTknter

        #  Set the frame layout's descriptors

        self._str = "CTkFrameLayout17"
        self._repr = (
            "CTkFrameLayout17 (master={master}, *args={*args}, **kwargs={**kwargs})"
        )
