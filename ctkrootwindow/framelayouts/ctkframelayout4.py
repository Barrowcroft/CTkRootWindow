...
class CTkFrameLayout4(CTkFrameLayout):
    """CTkFrameLayout4
    ...
    def __init__(
        ...
        **kwargs: Any,
        ...
        self._main.grid(row=0, column=1, padx=0, pady=0, sticky="nsew")  # type: ignore - call to CustomTknter

        #  Set the frame layout's descriptors

        self._str = "CTkFrameLayout4"
        self._repr = (
            "CTkFrameLayout4 (master={master}, *args={*args}, **kwargs={**kwargs})"
        )
