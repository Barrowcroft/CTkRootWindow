...
class CTkFrameLayout3(CTkFrameLayout):
    """CTkFrameLayout3
    ...
    def __init__(
        ...
        **kwargs: Any,
        ...
        self._top.grid(row=0, column=0, padx=0, pady=(0, gutter), sticky="nsew")  # type: ignore - call to CustomTknter

        self._main = CTkFormattedFrame(self)
        self._main.grid(row=1, column=0, padx=0, pady=(0, gutter), sticky="nsew")  # type: ignore - call to CustomTknter

        self._bottom = CTkFormattedFrame(self, height=50)
        self._bottom.grid(row=2, column=0, padx=0, pady=0, sticky="nsew")  # type: ignore - call to CustomTknter

        #  Set the frame layout's descriptors

        self._str = "CTkFrameLayout3"
        self._repr = (
            "CTkFrameLayout3 (master={master}, *args={*args}, **kwargs={**kwargs})"
        )
