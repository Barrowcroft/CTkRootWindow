...
class CTkFrameLayout23(CTkFrameLayout):
    """CTkFrameLayout23
    ...
    def __init__(
        ...
        **kwargs: Any,
        ...
        self._bottom.grid(row=1, column=1, padx=(0, gutter), pady=0, sticky="nsew")  # type: ignore - call to CustomTknter

        self._right = CTkFormattedFrame(self, width=200)
        self._right.grid(row=0, column=2, rowspan=2, padx=0, pady=0, sticky="nsew")  # type: ignore - call to CustomTknter

        #  Set the frame layout's descriptors

        self._str = "CTkFrameLayout23"
        self._repr = (
            "CTkFrameLayout23 (master={master}, *args={*args}, **kwargs={**kwargs})"
        )
