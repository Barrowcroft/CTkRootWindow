...
class CTkFrameLayout15(CTkFrameLayout):
    """CTkFrameLayout15
    ...
    def __init__(
        ...
        **kwargs: Any,
        ...
        self._main.grid(  # type: ignore - call to CustomTknter
            row=1, column=1, padx=(0, gutter), pady=(0, gutter), sticky="nsew"
        )

        self._right = CTkFormattedFrame(self, width=200)
        self._right.grid(row=1, column=2, padx=0, pady=(0, gutter), sticky="nsew")  # type: ignore - call to CustomTknter

        self._bottom = CTkFormattedFrame(self, height=50)
        self._bottom.grid(row=2, column=0, columnspan=3, padx=0, pady=0, sticky="nsew")  # type: ignore - call to CustomTknter

        #  Set the frame layout's descriptors

        self._str = "CTkFrameLayout15"
        self._repr = (
            "CTkFrameLayout15 (master={master}, *args={*args}, **kwargs={**kwargs})"
        )
