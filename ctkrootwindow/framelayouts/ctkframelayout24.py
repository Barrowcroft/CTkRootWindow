...
class CTkFrameLayout24(CTkFrameLayout):
    """CTkFrameLayout24
    ...
    def __init__(
        ...
        **kwargs: Any,
        ...
        self._left.grid(  # type: ignore - call to CustomTknter
            row=0, column=0, rowspan=3, padx=(0, gutter), pady=0, sticky="nsew"
        )
        ...
        self._bottom.grid(row=2, column=1, padx=(0, gutter), pady=0, sticky="nsew")  # type: ignore - call to CustomTknter

        self._right = CTkFormattedFrame(self, width=200)
        self._right.grid(row=0, column=2, rowspan=3, padx=0, pady=0, sticky="nsew")  # type: ignore - call to CustomTknter

        #  Set the frame layout's descriptors

        self._str = "CTkFrameLayout24"
        self._repr = (
            "CTkFrameLayout24 (master={master}, *args={*args}, **kwargs={**kwargs})"
        )
